...
<div class="pt-5">
    <div class="container">
            <div class="row justify-content-center">
                <div v-for="(blog, index) in blogByCategory" :key="index" class="col-12 col-lg-6">
...
export default {
    ...
    computed: {
        ...mapState('blog', {
            blogByCategory: state => state.blogByCategory,
        }),
    },
    created() {
        //console.log('this created')
        this.$store.dispatch('blog/getBlogCategory',this.$route.params.slugcategories).then(() => {
            //do someting
        });
