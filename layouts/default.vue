    ...
    <div class="no-pd" id="content">
        <div class="container">
            ...
            <div class="instagrams">
                <div class="instagrams-container"><a class="instagrams-item" href="https://www.instagram.com/"><img src="@/assets/subuh/images/instagram/1.png" alt="Instagram image" />
                        <div class="instagrams-item__content"><i class="fab fa-instagram"></i>
                            <p>@ Gtute_News</p>
                        </div>
                    </a><a class="instagrams-item" href="https://www.instagram.com/"><img src="@/assets/subuh/images/instagram/2.png" alt="Instagram image" />
                        <div class="instagrams-item__content"><i class="fab fa-instagram"></i>
                            <p>@ Gtute_News</p>
                        </div>
                    </a><a class="instagrams-item" href="https://www.instagram.com/"><img src="@/assets/subuh/images/instagram/3.png" alt="Instagram image" />
                        <div class="instagrams-item__content"><i class="fab fa-instagram"></i>
                            <p>@ Gtute_News</p>
                        </div>
                    </a><a class="instagrams-item" href="https://www.instagram.com/"><img src="@/assets/subuh/images/instagram/4.png" alt="Instagram image" />
                        <div class="instagrams-item__content"><i class="fab fa-instagram"></i>
                            <p>@ Gtute_News</p>
                        </div>
                    </a><a class="instagrams-item" href="https://www.instagram.com/"><img src="@/assets/subuh/images/instagram/5.png" alt="Instagram image" />
                        <div class="instagrams-item__content"><i class="fab fa-instagram"></i>
                            <p>@ Gtute_News</p>
                        </div>
                    </a><a class="instagrams-item" href="https://www.instagram.com/"><img src="@/assets/subuh/images/instagram/1.png" alt="Instagram image" />
                        <div class="instagrams-item__content"><i class="fab fa-instagram"></i>
                            <p>@ Gtute_News</p>
                        </div>
                    </a><a class="instagrams-item" href="https://www.instagram.com/"><img src="@/assets/subuh/images/instagram/3.png" alt="Instagram image" />
...
<script>
import Nav from '@/components/Layouts/navBar.vue'
...
export default {
    ...
    components: {
        'app-nav': Nav,
        'app-footer': Footer,
        'app-footerContent': footerContent,
    },
    mounted: function () {
        //Variables
        ...
        function ititalSlide() {
            ...
            $(".blog-ocean__slider").slick(Object.assign({
                fade: true
            }, slideArrow));
        ...
        function tab() {
            (function newsBlockTab() {
                $(".tab-item").on("click", function (e) {
                    ...
                    foundSlide.slick(Object.assign({
                        infinite: false
                    }, slideArrow));
                });
            })();
